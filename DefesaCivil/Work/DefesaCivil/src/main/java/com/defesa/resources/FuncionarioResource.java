...
public class FuncionarioResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody FuncionarioNewDTO objDto) {
		Funcionario obj = service.fromNewDTO(objDto);
	...
	public ResponseEntity<List<Funcionario>> findAllAgentes() {

		List<Funcionario> list = service.findFuncPerfilAgente();
	...
	public ResponseEntity<FuncionarioPerfilDTO> perfil(@PathVariable Integer id) {
		FuncionarioPerfilDTO obj = service.buscaPerfil(id);
		return ResponseEntity.ok().body(obj);
	}
